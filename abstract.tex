...
The Atmospheric Radiation Measurement (ARM) Data Center collects data
...
atmospheric processes. Outliers in collected data however are common due to
instrument failure or extreme weather events and its critical to
identify and flag them. We employed multiple univariate, multivariate
and time series techniques for outlier detection methods and 
studied their efficacy. First, we examined Pearson correlation coefficient 
