...
meteorology, oceanography and GIS projects. All ARM data are publicly
available and can be downloaded from ARM Data Archive
(http://www.archive.arm.gov) where a large range of datasets ranging  
...
instruments. %Each instrument may only work on a specified
%time range. For the raw NetCDF dataset collected from each
%instrument, it contains multiple variables. 
...
Oklohoma, United States. SGP is ARM's largest and central facility and
